...
public:
    ...
    void initial(int nscale, int minWaveLength, float mult, float sigmaOnf, int matchNum);

    static cv::Mat1b GetIris(const pcl::PointCloud<pcl::PointXYZ> &cloud, Eigen::VectorXf &rowkey);
